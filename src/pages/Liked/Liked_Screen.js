...
import styles from './Liked_Style';
...
import { deleteDataLiked, getDataLiked } from '../../shared/services/Asycnstorage';
                                ...
                                {DataLiked.map((item, index) => (
                                    <TouchableOpacity key={index} style={styles.kategoriBox} onPress={() => selectItem(item)}>
                                        <View style={styles.kategoriBox_Left}>
                                            ...
                                            <TouchableOpacity style={styles.likeContainer} onPress={() => deleteDataLiked(item.id)}>
